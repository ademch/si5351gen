...
#define SI5351_DEVICE_STATUS_ADDR				0
#define SI5351_INTERRUPT_STATUS_ADDR			1
#define SI5351_INTERRUPT_MASK					2
#define SI5351_STATUS_SYS_INIT					(1<<7)
#define SI5351_STATUS_LOL_B						(1<<6)
#define SI5351_STATUS_LOL_A						(1<<5)
#define SI5351_STATUS_LOS						(1<<4)
#define SI5351_OUTPUT_ENABLE_CTRL_ADDR			3
#define SI5351_OEB_PIN_ENABLE_CTRL				9
#define SI5351_PLL_INPUT_SOURCE_ADDR			15
#define SI5351_CLKIN_DIV_MASK					(3<<6)
#define SI5351_CLKIN_DIV_1						(0<<6)
#define SI5351_CLKIN_DIV_2						(1<<6)
#define SI5351_CLKIN_DIV_4						(2<<6)
#define SI5351_CLKIN_DIV_8						(3<<6)
#define SI5351_PLLB_SRC							(1<<3)
#define SI5351_PLLA_SRC							(1<<2)

#define SI5351_CLK0_CTRL_ADDR					16
#define SI5351_CLK1_CTRL_ADDR					17
#define SI5351_CLK2_CTRL_ADDR					18
#define SI5351_CLK3_CTRL_ADDR					19
#define SI5351_CLK4_CTRL_ADDR					20
#define SI5351_CLK5_CTRL_ADDR					21
#define SI5351_CLK6_CTRL_ADDR					22
#define SI5351_CLK7_CTRL_ADDR					23
...
#define SI5351_CLK_INPUT_MULTISYNTH_RELAY		(2<<2)
#define SI5351_CLK_INPUT_MULTISYNTH				(3<<2)
...
#define SI5351_PLLA_PARAMETERS_ADDR				26
#define SI5351_PLLB_PARAMETERS_ADDR				34
#define SI5351_CLK0_PARAMETERS_ADDR				42
#define SI5351_CLK1_PARAMETERS					50
#define SI5351_CLK2_PARAMETERS					58
#define SI5351_CLK3_PARAMETERS					66
#define SI5351_CLK4_PARAMETERS					74
#define SI5351_CLK5_PARAMETERS					82
#define SI5351_CLK6_PARAMETERS_ADDR				90
...
#define SI5351_VXCO_PARAMETERS_0_7_ADDR			162
#define SI5351_VXCO_PARAMETERS_8_15_ADDR		163
#define SI5351_VXCO_PARAMETERS_16_21_ADDR		164
...
#define SI5351_CRYSTAL_LOAD_ADDR				183
 ...
 * @SI5351_VARIANT_A3: Si5351A (3 output clocks, XTAL input) MSOP10
...
public:
	...
	uint8_t set_freq_manual(enum si5351_clock, uint64_t);

	void set_pll_freq(enum si5351_pll, uint64_t);
	void set_clock_enable(enum si5351_clock, bool);
	...
	void set_multisynth_source(enum si5351_clock, enum si5351_pll);

	void set_clock_powerON(enum si5351_clock, bool);
	void set_clock_invert(enum si5351_clock, bool);
	void set_clock_source(enum si5351_clock, enum si5351_clock_source);
	void set_clock_disabled_state(enum si5351_clock, enum si5351_clock_disable);
	void set_clock_fanout(enum si5351_clock_fanout, bool);
...
private:
	...
	void multisynth_calc_p1p2p3(uint64_t, uint64_t&, struct Si5351RegSet *);
